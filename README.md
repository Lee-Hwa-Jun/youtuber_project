...
| [`feed-sorter/`](./feed-sorter/) | 🔢 Feed Sorter (개인용) | TikTok·Instagram 피드를 조회수·좋아요·댓글·날짜순으로 재정렬하고 썸네일에 스탯·해시태그를 표시, 마우스를 올리면 정확한 업로드 시각(내 시간대)을 보여주는 크롬 확장 | `chrome://extensions` → 개발자 모드 → 압축해제된 확장 프로그램 로드 |
